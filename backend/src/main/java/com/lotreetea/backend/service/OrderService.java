...
public class OrderService {
    ...
    // NOTE: This method "restores" inventory first. However, it does not revert the order upon "out of stock" exception and will break.
    ...
    public Order updateOrder(Integer orderId, Order updatedOrder) {
        ...
        if (existingOrder.getOrderItems() != null) {
            for (OrderItem oldItem : existingOrder.getOrderItems()) {
                List<MenuItemComponent> oldComponents = menuItemComponentRepo.findByMenuItem_MenuItemId(oldItem.getMenuItemId());
        ...
        if (updatedOrder.getOrderItems() != null) {
            for (OrderItem newItem : updatedOrder.getOrderItems()) {
                ...
                List<MenuItemComponent> newComponents = menuItemComponentRepo.findByMenuItem_MenuItemId(newItem.getMenuItemId());
